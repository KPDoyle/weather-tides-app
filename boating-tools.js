(() => {
  ...
  style.textContent='.segment{grid-template-columns:repeat(3,1fr)}.traffic-map{position:relative;min-height:520px;border-radius:18px;overflow:hidden;background:rgba(0,0,0,.12)}.traffic-map iframe{display:block;width:100%;height:520px;border:0;background:#0b2035}.traffic-loading{display:grid;place-items:center;min-height:520px;padding:24px;text-align:center;opacity:.75}.traffic-actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:12px}.traffic-actions a{text-decoration:none}.boat-plan-summary{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-bottom:14px}.boat-plan-summary>div,.boat-checklist>div{padding:13px;border:1px solid rgba(255,255,255,.12);border-radius:14px;background:rgba(255,255,255,.05)}.boat-plan-summary span,.boat-checklist span{display:block;font-size:11px;letter-spacing:.055em;text-transform:uppercase;opacity:.68}.boat-plan-summary strong,.boat-checklist strong{display:block;margin-top:5px;font-size:15px}.boat-checklist{display:grid;grid-template-columns:repeat(2,1fr);gap:10px}.boat-checklist .wide{grid-column:1/-1}.condition-good strong{color:#88f2c0}.condition-watch strong{color:#ffd277}.condition-caution strong{color:#ff9b91}@media(max-width:720px){.traffic-map,.traffic-map iframe,.traffic-loading{min-height:430px;height:430px}.boat-plan-summary,.boat-checklist{grid-template-columns:1fr}.boat-checklist .wide{grid-column:auto}}';
  ...
  function switchTab(name){
    ...
    Object.entries(panels).forEach(([key,id])=>{const p=document.getElementById(id);if(p)p.hidden=key!==name});
